...
import { rolePermissionsToObject } from '../../config/rbacConfig';
...
export const DEFAULT_ROLE_PERMISSIONS = {
    ...
    manager: rolePermissionsToObject('manager'),
    cashier: rolePermissionsToObject('cashier'),
    viewer: rolePermissionsToObject('viewer'),
    sales_person: rolePermissionsToObject('sales_person'),
    employee: rolePermissionsToObject('employee'),
    inventory: rolePermissionsToObject('inventory'),
  };
